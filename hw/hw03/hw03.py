...
def missing_digits(n):
    ...
    miss = 0 if last - next_last <= 1 else last - 1 - next_last
...
def count_change(total):
    ...
    def change_helper(total, smallest_coin):
        ...
        without_coin = change_helper(total, smallest_coin * 2)
        with_coin = change_helper(total - smallest_coin, smallest_coin)
